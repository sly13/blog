              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-sm-12 footer-widget widget-categories">
                  ...
                  <ul>
                    <li>
                      <a href="/">
                        <span className="catTitle">Robotics</span>
                        <span className="catCounter"> (5)</span>
                      </a>
                    </li>
                    <li>
                      <a href="/">
                        <span className="catTitle">Games</span>
                        <span className="catCounter"> (6)</span>
                      </a>
                    </li>
                    <li>
                      <a href="/">
                        <span className="catTitle">Gadgets</span>
                        <span className="catCounter"> (5)</span>
                      </a>
                    </li>
                    <li>
                      <a href="/">
                        <span className="catTitle">Travel</span>
                        <span className="catCounter"> (5)</span>
                      </a>
                    </li>
                    <li>
                      <a href="/">
                        <span className="catTitle">Health</span>
                        <span className="catCounter"> (5)</span>
                      </a>
                    </li>
                    <li>
                      <a href="/">
                        <span className="catTitle">Architecture</span>
                        <span className="catCounter"> (5)</span>
                      </a>
                    </li>
                    <li>
                      <a href="/">
                        <span className="catTitle">Food</span>
                        <span className="catCounter"> (5)</span>
                      </a>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      <div className="tweet-text">
                        ...
                        Please, Wait for the next version of our templates to
                        update /Joomla 3.7

                    ...
                    <ul className="nav navbar-nav">
                      ...
                      {/* <li className="nav-item dropdown mega-dropdown">
                        <a
                          ...
                          aria-expanded="false"
                        >
                          Lifestyle <i className="fa fa-angle-down" />
                        </a>
                        <div className="dropdown-menu mega-menu-content clearfix">
                          <div className="menu-tab">
                            <div className="row">
                              <ul
                                className="nav nav-tabs flex-column col-2"
                                data-toggle="tab-hover"
                              >
                                <li className="nav-item">
                                  <a
                                    className="nav-link animated fadeIn active"
                                    href="#tab-A"
                                    data-toggle="tab"
                                    aria-selected="true"
                                  >
                                      ...
                                      <div className="post-block-style clearfix">
                                        ...
                                        <div className="post-content">
                                          <h2 className="post-title title-small">
                                            <a href="/">
                                              That wearable on your wrist could
                                              soon track your…
                                            </a>
                                          </h2>
                                        </div>
                                    ...
                                    <div className="col-md-3">
                                      <div className="post-block-style clearfix">
                                        ...
                                        <div className="post-content">
                                          <h2 className="post-title title-small">
                                            <a href="/">
                                              Can't shed those Gym? The problem
                                              might be in your…
                                            </a>
                                          </h2>
                                        </div>
                                    ...
                                    <div className="col-md-3">
                                      <div className="post-block-style clearfix">
                                        ...
                                        <div className="post-content">
                                          <h2 className="post-title title-small">
                                            <a href="/">
                                              Deleting fears from the brain
                                              means you might neve…
                                            </a>
                                          </h2>
                                        </div>
                                      </div>
                              ...
                              <div className="col-md-3">
                                <div className="post-block-style clearfix">
                                  ...
                                  <div className="post-content">
                                    <h2 className="post-title title-small">
                                      <a href="/">
                                        Netcix cuts out the chill with an
                                        integrated...
                                      </a>
                                    </h2>
                                  </div>
                              ...
                              <div className="col-md-3">
                                <div className="post-block-style clearfix">
                                  ...
                                  <div className="post-content">
                                    <h2 className="post-title title-small">
                                      <a href="/">
                                        TG G6 will have dual 13-megapixel
                                        cameras...
                                      </a>
                                    </h2>
                                  </div>
                        ...
                        <ul className="dropdown-menu" role="menu">
                          <li className="dropdown-submenu">
                            ...
                            <ul className="dropdown-menu">
                              ...
                              <li>
                                <a href="category-style3.html">
                                  Category Style 3
                                </a>
                              </li>
                              <li>
                                <a href="category-style4.html">
                                  Category Style 4
                                </a>
                              </li>
                            </ul>
                          ...
                          <li className="dropdown-submenu">
                            ...
                            <ul className="dropdown-menu">
                              <li>
                                <a href="single-post1.html">Single Post 1</a>
                              </li>
                              <li>
                                <a href="single-post2.html">Single Post 2</a>
                              </li>
                              <li>
                                <a href="single-post3.html">Single Post 3</a>
                              </li>
                              <li>
                                <a href="single-post4.html">Single Post 4</a>
                              </li>
                            </ul>
                          </li>
                          <li className="dropdown-submenu">
                            ...
                            <ul className="dropdown-menu">
                              ...
                              <li>
                                <a href="single-post1.html">Right Sidebar</a>
                              </li>
                              <li>
